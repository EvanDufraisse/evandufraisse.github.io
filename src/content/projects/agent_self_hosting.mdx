...
<div id="toc" class="bg-black/5 dark:bg-white/10 rounded-lg px-6 py-1 shadow-lg transition-none">
  <nav>
    ...
    <ul class="list-disc list-inside text-gray-700 dark:text-gray-300 space-y-4">
      <li class="text-lg font-semibold text-gray-900 dark:text-gray-100"><a href="https://evandufraisse.github.io/posts/self-hosted/self_hosting_configure_network">Configure a Secure Connection to Your Homelab</a></li>
      </ul>
  </nav>
</div>
